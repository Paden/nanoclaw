...
export const COMPACT_TOKEN_THRESHOLD = parseInt(
  process.env.COMPACT_TOKEN_THRESHOLD || envConfig.COMPACT_TOKEN_THRESHOLD || '100000',
  10,
);
export const COMPACT_MODEL = process.env.COMPACT_MODEL || envConfig.COMPACT_MODEL || 'gemma4:31b-cloud';
